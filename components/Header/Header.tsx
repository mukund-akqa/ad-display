  ...
  return (
    <header className={styles.header}>
      <div className={styles.header_brand}>
        ...
        />
        <Link href="/" className={styles.header_brand_text}>
          AdXchange
        </Link>
      </div>
      ...
      <nav className={styles.nav}>
        ...
        <ul
          className={
            isNavExpanded ? styles.nav_links_expanded : styles.nav_links
          }
        >
          <li>
            {state ? (
              <Link href="/" className={styles.nav_text} onClick={handleLogout}>
                Logout
              </Link>
            ) : (
          ...
          <li>
            {state ? (
              <Link href="/account" className={styles.nav_text}>
                My account
              </Link>
            ) : (
